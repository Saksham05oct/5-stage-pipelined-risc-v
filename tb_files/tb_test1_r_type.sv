...
module tb_test1_r_type;
  ...
  initial begin
    ...
    write_instruction(32'h00, 32'h00a00093); // addi x1, x0, 10
    write_instruction(32'h04, 32'h00300113); // addi x2, x0, 3
    write_instruction(32'h08, 32'h002081b3); // add x3, x1, x2    (10 + 3 = 13)
    write_instruction(32'h0C, 32'h40208233); // sub x4, x1, x2    (10 - 3 = 7)
    write_instruction(32'h10, 32'h0020f2b3); // and x5, x1, x2    (10 & 3 = 2)
    write_instruction(32'h14, 32'h0020e333); // or x6, x1, x2     (10 | 3 = 11)
    write_instruction(32'h18, 32'h0020c3b3); // xor x7, x1, x2    (10 ^ 3 = 9)
    write_instruction(32'h1C, 32'h00211433); // sll x8, x2, x2    (3 << 3 = 24)
    write_instruction(32'h20, 32'h0020d4b3); // srl x9, x1, x2    (10 >> 3 = 1)
    write_instruction(32'h24, 32'h00112533); // slt x10, x2, x1   (3 < 10 signed = 1)
    write_instruction(32'h28, 32'h001135b3); // sltu x11, x2, x1  (3 < 10 unsigned = 1)
    write_instruction(32'h2C, 32'h00302023); // sw x3, 0(x0)
    write_instruction(32'h30, 32'h00402223); // sw x4, 4(x0)
    ...
    $display("mem[4]    = %d (exp 7)",  read_dmem_word(4));
    ...
    if (read_dmem_word(4) !== 32'd7)              test_passed = 0;
